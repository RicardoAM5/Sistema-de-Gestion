import { galletasApiUrl, galletasUpdateApiUrl, galletasDeleteApiUrl, galletasInsertApiUrl } from "./modules/apiUrls.js"
      ...
      content += `
            ...
            <td>
                ...
                <button
                    ...
                    data-bs-toggle='modal' data-bs-target='#updateCookie'
                    onclick="editarGalleta(${galletasUpdateApiUrl},${data})"
                ...
                <button
                    ...
                    onclick="eliminarGalleta('${galletasDeleteApiUrl}','${data.idGalleta}')"
                    >
